...
var Presets = []PresetInfo{
	...
	{"walk", "Walk", "Basics", "side-view walking cycle facing right", 6, 10, true, "Readable side-view walking cycle: alternating legs with clear contact and passing poses, opposite arm swing, slight body bob. Each frame shows a distinctly different leg position."},
	{"run", "Run", "Basics", "fast side-view running cycle facing right", 6, 12, true, "Fast side-view running cycle: strong forward lean, large leg extension with airborne moments, pumping arms, pronounced body bob. Each frame is a distinct stride phase."},
