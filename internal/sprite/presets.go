...
var Presets = []PresetInfo{
	// ── Basics ──
	{"idle", "Idle", "Basics", "a lively idle: breathing, subtle weight shift, small alive motion in place", 4, 6, true, "Characterful idle that reads as alive: clear breathing with the chest and shoulders rising and falling, a subtle weight shift and gentle body sway, the head and hands drifting slightly, an occasional blink. Keep it lively and readable, but the feet stay firmly planted in the exact same spot in every frame."},
	{"idle-combat", "Combat Idle", "Basics", "a tense combat-ready stance, weapon up, weight shifting", 4, 8, true, "Alert combat-ready idle with coiled tension: knees bent in an athletic stance, weapon or fists raised and ready, weight shifting actively side to side, a small breathing bob. Stay charged and dangerous; feet stay planted and the stance never relaxes; loops cleanly."},
	...
	{"sleep", "Sleep", "Basics", "sleeping, slow gentle breathing", 4, 4, true, "Calm sleeping cycle: lying down with eyes closed, slow gentle breathing rising and falling, an occasional small shift. Very serene, minimal motion; loops smoothly."},
	...
	{"meditate", "Meditate", "Magic & Skills", "sitting meditation, calm breathing", 4, 4, true, "Meditation loop: seated cross-legged, hands resting on the knees, eyes closed, very slow calm breathing rising and falling. Minimal, serene motion; loops smoothly."},
	...
	{"think", "Think", "Emotion", "thinking with a hand on the chin", 4, 6, true, "Thinking loop: one hand to the chin, the head tilted, weight shifting slowly side to side, an occasional small head tilt. Pondering, subtle looping motion."},
